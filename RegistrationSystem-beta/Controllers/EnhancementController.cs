...
namespace RegistrationSystem.Controllers
{
    ...
    public class EnhancementController : Controller
    {
        ...
        public IActionResult Enhancement(string Enh_Sys_Code, string Enh_Mod_Code, string Enh_Code)
        {
            ViewBag.Sys_Code = Enh_Sys_Code;
            ViewBag.Mod_Code = Enh_Mod_Code;
            return View("Enhancement", repository.Enhancements.FirstOrDefault(r => r.Enh_Sys_Code == Enh_Sys_Code &&
                                                                                   r.Enh_Mod_Code == Enh_Mod_Code &&
                                                                                   r.Enh_Code == Enh_Code));
        }
        /*
        public IActionResult Enhancement(Enhancement enh)
        {
            ViewBag.Sys_Code = enh.Enh_Sys_Code;
            ViewBag.Mod_Code = enh.Enh_Mod_Code;
            return View("Enhancement", enh);
        }
        */
        [HttpPost]
        public IActionResult EnhancementForm(Enhancement enh)
        {
            ...
            ViewBag.Sys_Code = enh.Enh_Sys_Code;
            ViewBag.Mod_Code = enh.Enh_Mod_Code;
            return View(nameof(EnhancementController.Enhancement));
        }

        public IActionResult SearchSystem(string Enh_Sys_Code)
        {
            ViewBag.ControllerName = "Enhancement";
            return View("Search", sys_repository.Search(Enh_Sys_Code));
        }
        ...
        {
            ViewBag.ControllerName = "Enhancement";
            return View(mod_repository.Search(Enh_Sys_Code, Enh_Mod_Code));
        }
        ...
        public IActionResult Edit(Enhancement enh) =>
            RedirectToAction(nameof(EnhancementController.Enhancement), enh);
