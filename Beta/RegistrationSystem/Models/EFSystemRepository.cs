...
namespace RegistrationSystem.Models
{
    public class EFSystemRepository : ISystemRepository
    {
        ...
        public System MoveFirst() => context.Systems.FirstOrDefault();

        public System MovePrev(string current_sys_code)
        {
            if (string.IsNullOrWhiteSpace(current_sys_code) ||
                string.Compare(context.Systems.FirstOrDefault().Sys_Code, current_sys_code) == 0)
        ...
        public System MoveLast() => context.Systems.LastOrDefault();
        ...
        public System MoveNext(string current_sys_code)
        {
            ...
            if(string.Compare(context.Systems.LastOrDefault().Sys_Code, current_sys_code) == 0)
                return context.Systems.LastOrDefault();
